...
# She has to cover the cost of child and elderly care.
  ...
  if(Way == 7){
    ...
    profit_with_with_Job_away_of_farm<- (Mix - Mix_inv + State_insurance - State_insurance_inv) * (1- Husband_risk  * Bancruptcy_risk * Divorce_risk)
...
## in the compound figurte, we are forced to use the wrong input table as an input, therefore we get bad results for some plots.
