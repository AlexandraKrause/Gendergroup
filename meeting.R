...
profit_with_On_Farm_Job <- ((State_insurance - State_insurance_inv- Costs_for_child_care - Costs_for_elderly_care) * (1- Bancruptcy_risk * Man_Death_risk * Divorce_risk * Husband_risk))

# Way 6 = Payment of wife (on farm job) with investment in private insurance
profit_with_On_Farm_Job <- ((State_insurance - State_insurance_inv - Private_insurance_inv + Private_insurance - Costs_for_child_care - Costs_for_elderly_care) * (1- Bancruptcy_risk * Man_Death_risk * Divorce_risk * Husband_risk))
