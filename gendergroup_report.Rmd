...
Our Model entails 14 options we call „ways“, divided in 4 branches. Usually, there are 4 options per way: a so to say „ basic“ option just being paid for different kinds of work and then topping it with ETF, private insurance and mix of etf and private insurance
...
we compare each way to the Status quo, where the costs for agricultural insurance are paid by husband. 
...
Analogue to @do_decision_2020, best option for a decision maker may largely depend on their discount rate. In our Model, we have used the dicount rate f 1. It would be desirable to provide a range of different dicount rates, to incoperete the different dicout rates of different decision makers. 

To 

## Risks
In our initial Version of the Model, we incooperaded the risks. 
