...
Our inital model draft was based on literature (WEBSITES USED TO GET THIS INFORMATION?) and personal experiences (Figure 1). It displays both decision options that lead to her pension i.e. the decision option 1 aka default option and decision option 2 of choosing a pension plan.
...
Figure 3 shows an overview of the participants, their status in our research, and whether they partook in an interview and/or in the workshop.
...
The previous determination of our decision maker (see section 3.1 Decision maker) allowed us to fill our input table with values (Figure 6).
