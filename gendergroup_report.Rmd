...
```
TO DO:
- PROVIDE SOURCE IN LINE 53
- CREATE TABLE AS OVERVIEW OF FEATURES OF DECISION MAKER? (LINE 79)
- FINISH SECTION STAKEHOLDERS
- FIX FIGURE CAPTIONS SO ALL LOOK THE SAME (LINE 144)
- USE MERMAID TO CREATE FIGURE 4 AND 5 INSTEAD OF USING PICTURES (SECTION ADJUSTMENT OF CONCEPTUAL MODEL- LINES 151-153 AND 164-166) --> MERMAID DRAFT ALINA STARTING LINE 200
- PROVIDE SOURCES THAT LEAD TO FIRST DRAFT OF CONCEPTUAL MODEL (LINE 108)
- WHY DID WE EXCLUDE PROPERTY AS PENSION SCHEME IN UPDATED MODEL? (LINE 154)
- UPDATE CORRECT INPUT TABLE --> YEARS OR MONTH? (LINE 181 - 185)
- CORRECT MONTHLY OR YEARLY IN TEXT (LINE 177)
- SOURCE FOR AVERGAE FEMALE LIFE EXPECTANCY IN GERMANY (LINE 177)
- WRTIE ABSTRACT
