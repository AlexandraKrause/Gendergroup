...
To answer the question, how risks could be better implemented in cases like this where binominal distributions are unfortunately, the use of a weibull-distribution would be fortunate (source: https://mediatum.ub.tum.de/doc/1479942/1479942.pdf)....how do i get sources in?
https://mediatum.ub.tum.de/doc/1472787/1472787.pdf). better sources: brandel et al. 2020, paul et al 2019 (i have them on my desctop)...i will write more text regarding this, but it is hard to explain...i will work on it in word first)
