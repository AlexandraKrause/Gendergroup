...
##EVPI
To guide further research we conducted an analysis in order to calculated the expected value of perfect information (EVPI). The EVPI represents the amount of money our decision maker should be willing to pay to reduce the uncertainty concerning the respective variable. The variables with the highest uncertainty are shown. The EVPI shows where it would be suggested to invest more money to get better information about one variable. For broader ranges of lower and upper values, or rather more insecurity in the calculation of one variable the EVPI is positive. Further research could observe these variables to better the models.
