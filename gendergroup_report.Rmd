...
After receiving a calibration training in the DA-Course, we considered ourselves calibrated experts and were able to estimate reasonable ranges based on a mixed approach of literature research and expert opinion.
...
The model was created in accordance with @R-decisionSupport [and is available in our Github repository](https://github.com/AlexandraKrause/Gendergroup/). 
 The heart of our model are the yearly payments into agricultural or state pension for 40 years (€/year) and the yearly pension payout for 17 years (€/year). 
