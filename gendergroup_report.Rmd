...
In the first branch our decision-maker sets up her own business branch on her husbands farm. Here, she continues to be part of the agricultural insurance, but also invests about 10 % of her income in private insurance, ETF or a mixed investment. The NPVs from the decision clearly show, that these options are not attractive to our decision maker (see Fig. \@ref(fig:NPVbranch1)) . Even tough the pension payout is considerably higher, the default option with the small pension comes for free. The investment in an private insurance together with the mandatory agricultural insurance, payed by having an own business branch on the farm (way 1) has an outcome of - 115,000 to less than -60,000 Euro and is the least attractive option here. The option to invest into ETF was the one with the highest predicted outcome, followed by the decision for a mixed investment.
...
Here, option four (no aditional investment) and five (private insurance) have solely negative values (see Fig. figure \@ref(fig:NPVbranch2)). In option 4 is the investment into the mandatory state insurance payed by an off-farm job which differs from the baseline option between -30,000 to -70,000 Euro. Option 7, the decision for a mixed investment can have negative values as well with a range from -20,000 to 40,000 Euro. But option 6, the investment in ETF is solely positive with values from 20,000 to 110,000 Euro compared to the option of sticking to status quo. 
...
ETF is the investment with the highest predicted outcome followed by the mixed investment again.
...
Option 10 is the only solely option of this group with positive values smaller than 10.000 and higher than 60,000 Euro. It is the investment in ETF and state insurance payed by a job on the farm. 
Option 11 is the decision to use the money for a mixed investment instead of ETF under the same conditions. The outcome is mostly negative with values from more than -25.000 to 10.000 Euro. The other options have no positive values and losses over 60.000 Euro.
...
In figure \@ref(fig:NPVbranch4) all options had a wide range. Way 12 is the option of paying in private insurance next to the mandatory agricultural insurance with family money. It showed the smallest range if the three option with a range of over - 200,000 to over 150,00 Euro, that could be achieved when deciding for this option. An even broader range from -100,00 to over 150,00 Euro was achieved with way 13, where under the same conditions an ETF was chosen instead of a private insurance. The highest difference in possible outcomes can be seen in way 14 with over - 200,000 to 150,00 Euro, where a mixed investment is chosen over an ETF. Compared to these the default option had an NPV of more or less than 74,200 to 75,600 with very small, estimated ranges.
The NPVs from the decision show, that most options are barely more attractive than the default to our decision maker when it comes to ranges, even though more money could potentially be achieved with a decision for ETF and the mixed investment. This time the investment into a mix of private insurance and ETF had the broadest range of outcomes and very negative predicted outcome values as well, while the investment into an ETF was the most beneficial, even though the range of outcome was very broad as well.

Many of our decision options have a negative NPV. The reason is that we compared each of our ways to the default option, in which the woman receives very little retirement, but as her husband covers the cost for the mandatory insurance, she has no cost at all. 
...
```{r NPVway14, fig.cap = "NPV Way 14", echo=FALSE}
#NPVs compared
...
# cite this figure with \@ref(fig:NPVway14)
```

 
Here the NPVs of the options without substracting the NPV of no branch are compared to each other. The NPVs that differed the most from the baseline option were those of investing into ETF with a job away from the farm (way 6, Fig. \@ref(fig:NPVway6)) as well as investing into ETF (way 13, Fig. \@ref(fig:NPVway13))  and the mixed investment with using family money (way 13, Fig. \@ref(fig:NPVway13)). ETF_family_money differed from 5400 to 21,840 with an even broader difference of 21,840. 
Option 7, a mixed investment can have negative values as well with a range from -20,000 to 40,000 Euro. Broad ranges were observed for way 13, an investment into ETF with -100,00 to over 250,00 Euro and way 14 with -100,000 to over 150,00 Euro, where a mixed investment is chosen.

This shows again that the best investment options were ETF and mixed investment. In the case of way 14 the range of possible outcomes for mixed investment was even higher and more negative than that of ETF. The range of the input estimates for ETF_inv_family_money differed from 15,360 to 3840 with a difference of 11,520, while those for 
...
( i cannot raelly imagine that black rock calculations on which izr model was absed on include german tax rates. this would rateher be interesting for the uncertainty part down in the text)<-------<--------------------
