...
It is important to keep in mind that this is not always the case. As we learned in the workshop (see section Participatory research), a large number of farms chose to cancel the woman's agricultural pension because they prefer to invest the money into the farm directly.Also, the transfer of a family farm to the successor is oftentimes not a smooth process and might be realized later then expected. 
...
In this case study, we have provided a model which is not widely applicable to different family constellations. 
