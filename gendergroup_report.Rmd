...
The NPVs that differed the most from the baseline option were those of investing into ETF with a job away from the farm (way 6, Fig. \@ref(fig:NPVway6)) as well as investing into ETF (way 13, Fig. \@ref(fig:NPVway13))  and the investment mix with using family money (way 13, Fig. \@ref(fig:NPVway13)). (This shows again that the best investment options were ETF and mixed investment. In the case of way 13 the mixed investment was even higher than that of ETF, which was not the case for the other branches. The range of the input estimates for ETF_inv_family_money differed from 15,360 to 3840 with a difference of 11,520, while those for ETF_family_money 5400 to 21,840 with an even broader difference of 21,840. 
