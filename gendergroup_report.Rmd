...
our decision maker has two options to chose from.

Decision option 1 a.k.a. default option: 
...
Decision option 2 a.k.a. pension plan:
...
We identified four major stakeholders in this decision.
* The farmer is the husband of our decision maker. He may depend on her support when running his farming business. If he grew up on a family farm, he has most probably experienced his mother supporting in his fathers farm without formal employment contract.
* Children grow up on a farm and may have encountered the expectation to take the farm over at some point. 
* Young female farmers: Are about to decide how to arrange their work and family life on a farm. In case the farm comes from her partners family, she needs to find her place within the farms family sructure. If she inherits her own farm, whe still needs to set up a 
Being a farmer is luckily not connected to one gender - however, the 
...
Since pension payment and payouts are usually paid per month, we first used a monthly time unit in our code. However, doing that created a wide variety of outputs for 684 months (40 years of working and paying into her pension plus 17 years of receiving pension) making it highly complicated to create a straightforward output in the @R-decisionSupport. Thereforre we decided to use yearly time untis instead as intended by the @R-decisionSupport.

Our Model entails 14 „ways“, divided according to different income sources in 4 branches. In each Branch, she pays a mandatory insurance (either state or agricultural insurance). In addition there are differnt options to top this mandatory insurance with personal investments like ETF, private insurance and mix of etf and private insurance.
...
Each of the 14 Ways is compared to a default option. Here, our decision maker invests nothing in her retirement. The mandatory agricultural insurance, is not payed by her, but from her husband / family. 

Our Case study expands over 57 Years and is split into a period of 40 Years of payment and a period of 17 Years of Payout. From all insurances, investments and pensions we produce time series with variation. 
```{r }
...
In way 1, our decision maker sets up her own business branch. Analogue to the default option, she continues to be part of the agricultural insurance. However, she pays on her own. 
On Top, she invests about 10 % of her income in a private insurance. 
In Part A, her befits from the private insurance and agricultural insurance are summed up, wheras in PartB the Costs of the both insurancec are summed up. By subtracting the cost from the benefit, we obtain the NPV. The NPV is then discounted with a discount rate of 1. 
...
In the default option, the agricultural insurance is payed by the family. Therefore, the decision maker incur the benefit of receiving pension without own investment. 
...
To calculate the NPV of the decision, we subtract the default option from Way 1.
We perform this calculation on all the 14 Ways. 

```{r, eval=FALSE }   
  NPV_decision_profit_with_Own_business_branch_1 <- NPV_profit_with_Own_business_branch_1 - NPV_no_branch
```
  
In our return list, we include the NPV of the default option, the NPVs of the different interventions, the NPV of the decisions and the cashflow. 
...
Depending on the possiblities on farm and in the region, our decision maker can chose among differnt sources of income. The decision -maker may either start her own Branch on the family farm, pursue an off-farm job, ask her husband for a formal working contract for her work or ask her husband to pay for her retirement. 

Many of our Ways decision have a negative NPV. The reason is, that we compare our each of our Ways to the default option, in which the woman receives very little retirement, but as her family covers the cost for the mandatory insurance, she has no cost at all. 

HERE WE NEED THE PLOTS FROM THE DIFFERENT BRANCHES

## PLS
When checking the PLS for our differnt ways, it becomes apparent, thet the respective pension scheme has the highest impact. For example for Way one, The decision maker has a mandatory agricultral insurance and a private insurance. In The PLS, the investments in insurance appear negative whereas the payouts have a positive impact on the NPV of the decision. As our Model is quite Simple, this corresponds to our expectations. 

## Cashflow

The cashflow displays the biography of the decision maker. During the 40 years of work, the decison maker invests in her retirement. The payout is spread over the 17 Years of the pension. The cashflow shows ho the structure of pension investments - decision makers have to deal with long years of investment and negative cashflow and the return comes only in old age. 
...
##Risks
In our Model building process, we identified several risks which have the potentail to impair the model outcome. We estimated the likelihood of these risks to occur and incooperated them in our initial Version of the Model. Also, we identified the their potential impact on the NPV. However, The implementation of the Risks lead to misleading results, as our code applied the risks over end over, and was not sensitive to the time in the employment biography of the woman.  

|Risk |Description	|lower(%)	|upper (%)	|
|----	|-----------	|--	|--	|
|Risk in-laws decide |Percentage risk that in-laws/husband overrule daughter in-law/wife  |45 |50|    |
|Risk of divorce |Percentage risk that the marriage will be divorced at some point  |20 |40|    |
|Risk of fatal accident of husband |Percentage risk that farmer husband has a fatal accident at work  |0.01 |0.02|    |
|Risk of farm bancruptcy |Percentage risk that farm goes bancrupt  |1 |1.7| |


Risks: Problem with binominal distribution (0,1) and “infinity”(better word) over our time period
