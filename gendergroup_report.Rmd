...
```{r, echo=FALSE, out.width='100%', fig.align='center', fig.cap="Adjusted decision option 2 pathways of financing her own retirement", fig.show='hold'}
...
```{r, echo=FALSE, out.width='100%', fig.align='center', fig.cap= "Decision option 1 aka default option after the workshop", fig.show='hold'}
...
```{r tables, caption= "Input Table", echo=FALSE}
...
```{r , fig.cap= "NPV decision of own business branch", echo=FALSE}
#Plot own branch 
...
```{r , fig.cap = "NPV decision of off farm job", echo=FALSE}
#Plot off farm Job
decisionSupport::plot_distributions(mcSimulation_object = mcSimulation_results, 
...
```{r , fig.cap = "NPV decision of on farm job", echo=FALSE}
#Plot on farm job
decisionSupport::plot_distributions(mcSimulation_object = mcSimulation_results, 
...
```{r , fig.cap = "NPV decision of family money", echo=FALSE}
#Plot Family Money
decisionSupport::plot_distributions(mcSimulation_object = mcSimulation_results, 
...
```{r , fig.cap = "Cashflow of way 1", echo=FALSE}
...
```{r , fig.cap = "PLS way 1", echo=FALSE}
