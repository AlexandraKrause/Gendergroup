...
This report was compiled using tools from the @R-knitr team. The model was created with the @R-decisionSupport. @tidyverse2019
@R-tidyverse
@R-DiagrammeR
...
### Model conceptualization with stakeholders
