...
In a brainstorming session, we collected different risks for each option. If she sticks to the status quo (i.e. default option) she is financially dependent on her family-in-law. Events that could highly threaten her pension in this case are a possible divorce, a fatal accident at the work of her husband, or the bankruptcy of the farm.
...
In the end, we were left with four financing options, we refer to as 'branches'.Three of which require initial investment costs in form of covering child and elderly care. Establishing an own branch on the farm itself, particularly in form of setting up a farm shop, delivery service or holiday housing seemed to be popular among workshop participants. Identified risks for this option were the circumstance of divorce and the bankruptcy of the farm.
Getting an off farm job or negotiating with the in-laws to be officially employed at the farm was also mentioned frequently.Here, the risks are related to the farm and therefore identical with the ones for 'own branch on farm' (i.e. risk of divorce, bankruptcy).
