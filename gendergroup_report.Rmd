...
The model was created in accordance with @R-decisionSupport. [It is available in our Github repository](https://github.com/AlexandraKrause/Gendergroup/) It was run using a Monte-Carlo simulation with 10.000 repetitions.
...
# cite this figure with \@ref(fig:NPV-outcome_seperated)
```
